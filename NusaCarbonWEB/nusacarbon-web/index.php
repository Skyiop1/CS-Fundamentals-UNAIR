...
<head>
    ...
    <style>
        ...
        @media(max-width: 768px) { .hero-title { font-size: 4rem; } }
        ...
        .role-grid {
            ...
            margin-top: 60px; width: 100%; max-width: 1000px; padding: 0 24px;
        }
        ...
        .role-card {
            ...
            text-decoration: none; display: flex; align-items: flex-start; gap: 20px;
        }
        .role-card:hover {
        ...
        [data-theme="dark"] .role-card:hover { box-shadow: 0 20px 40px rgba(0,0,0,0.4); }

        .icon-wrapper { padding: 16px; border-radius: 16px; display: inline-flex; align-items: center; justify-content: center; }
        .role-card.buyer .icon-wrapper { background: rgba(16,185,129,0.1); color: #10b981; }
        .role-card.owner .icon-wrapper { background: rgba(14,165,233,0.1); color: #0ea5e9; }
        .role-card.verifier .icon-wrapper { background: rgba(139,92,246,0.1); color: #8b5cf6; }
        .role-card.admin .icon-wrapper { background: var(--card-border); color: var(--text-main); }

        /* Blockchain Stats Section */
        .network-stats {
            margin-top: 100px; padding: 60px 24px; width: 100%; max-width: 1100px;
            display: flex; flex-direction: column; gap: 40px;
        }
        @media (min-width: 900px) {
            .network-stats { flex-direction: row; justify-content: space-between; align-items: stretch; }
            .network-stats .col-left { flex: 1; padding-right: 60px; border-right: 1px solid var(--card-border); }
        ...
        .network-stats p { font-size: 1.1rem; color: var(--text-muted); line-height: 1.6; }
        .stat-item { display: flex; align-items: center; gap: 24px; }
        .stat-icon { color: var(--text-muted); opacity: 0.5; }
        .stat-value { font-size: 3.5rem; font-family: monospace; font-weight: 700; letter-spacing: -2px; line-height: 1; margin-bottom: 8px; color: var(--text-main); }
        .stat-label { color: var(--text-muted); font-size: 0.95rem; font-weight: 500;}

        /* Extended Info Layout */
        .ecosystem-section {
            margin-top: 40px; margin-bottom: 80px; width: 100%; max-width: 1100px; padding: 0 24px;
        }
        .info-grid {
        ...
        .info-card {
            ...
            padding: 40px 32px; border-radius: 24px; text-align: left;
        }
        .info-card h3 { font-size: 1.4rem; margin-bottom: 16px; color: var(--text-main); font-weight: 700; }
        .info-card p { font-size: 0.95rem; color: var(--text-muted); line-height: 1.6; margin: 0; }
        
        .info-card .num { font-family: monospace; font-size: 1.2rem; margin-bottom: 24px; color: #10b981; font-weight: bold; }

        /* Fat Footer */
        .fat-footer {
            width: 100%; border-top: 1px solid var(--card-border); padding: 80px 24px 40px 24px;
            background: rgba(0,0,0,0.01);
            display: flex; flex-direction: column; align-items: center;
        }
        .fat-footer-inner {
            width: 100%; max-width: 1100px; display: grid; grid-template-columns: 1fr; gap: 60px;
        }
        @media (min-width: 768px) { .fat-footer-inner { grid-template-columns: 2fr 1fr 1fr; } }
        
        .fat-footer .brand { margin-bottom: 24px; display: flex; align-items: center; gap: 10px; font-weight: 700; font-size: 1.5rem; }
        .fat-footer p { color: var(--text-muted); font-size: 0.95rem; line-height: 1.6; max-width: 300px; margin-bottom: 24px; }
        .social-icons { display: flex; gap: 16px; color: var(--text-muted); }
        .social-icons svg { cursor: pointer; transition: 0.2s; }
        .social-icons svg:hover { color: var(--text-main); }
        
        .footer-col h4 { font-size: 1rem; font-weight: 600; margin-bottom: 20px; color: var(--text-main); }
        .footer-col ul { list-style: none; padding: 0; margin: 0; }
        .footer-col ul li { margin-bottom: 12px; }
        .footer-col ul li a { color: var(--text-muted); text-decoration: none; font-size: 0.9rem; transition: 0.2s; }
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <header style="width: 100%; padding: 24px 40px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--card-border);">
            <div style="display: flex; align-items: center; gap: 12px; font-weight: 800; font-size: 1.4rem; letter-spacing: -0.5px;">
        ...
        <main style="width: 100%; display: flex; flex-direction: column; align-items: center; text-align: center; padding: 60px 24px 0 24px;">
            <div class="fade-up">
                <span style="background: rgba(16,185,129,0.1); color: #10b981; padding: 6px 16px; border-radius: 50px; font-size: 13px; font-weight: 600; border: 1px solid rgba(16,185,129,0.2); letter-spacing: 0.5px; text-transform: uppercase;">Infrastruktur Berkelanjutan</span>
            ...
            <div class="role-grid fade-up" style="animation-delay: 100ms;">
                <a href="/login.php?role=buyer" class="role-card buyer">
                    ...
                    <div>
                        <h3 style="margin: 0 0 8px 0; font-size: 1.25rem;">Corporate Wallet</h3>
                        <p style="margin: 0; font-size: 0.95rem; color: var(--text-muted);">Beli & ofset emisi (burn) karbon melalui pasar secara langsung.</p>
                    </div>
                </a>
                <a href="/login.php?role=owner" class="role-card owner">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.95rem; color: var(--text-muted);">Mendaftarkan tanah, hutan, dan proyek energi terbarukan.</p>
                    </div>
                </a>
                <a href="/login.php?role=verifier" class="role-card verifier">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.95rem; color: var(--text-muted);">Platform dMRV untuk pihak ketiga dan auditor lingkungan.</p>
                    </div>
                </a>
                <a href="/login.php?role=admin" class="role-card admin">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.95rem; color: var(--text-muted);">KYC terpadu guna memastikan keamanan antar entitas lembaga.</p>
                    </div>
                </a>
            </div>
            ...
            <div class="ecosystem-section fade-up" style="animation-delay: 200ms; text-align: left; margin-top: 100px;">
                <h2 style="font-size: 2.2rem; font-weight: 800; letter-spacing: -1px; margin-bottom: 12px;">Solusi iklim yang nyata</h2>
                <p style="font-size: 1.1rem; color: var(--text-muted); max-width: 600px;">Setiap metrik lingkungan diaudit dan dibuktikan secara matematis, mencegah terjadinya greenwashing (klaim palsu) pada level korporat.</p>
                
                <div class="info-grid">
                    <div class="info-card">
                        <div class="num">01</div>
                        <h3>Proses Tokenisasi</h3>
                        <p>Aset fisik seperti kemampuan penyerapan CO₂ lahan gambut divalidasi dan diubah menjadi aset digital di dalam buku besar NusaCarbon agar dapat ditransaksikan tanpa kehilangan jejak audit.</p>
                    </div>
                    <div class="info-card">
                        <div class="num">02</div>
                        <h3>digital MRV</h3>
                        <p>Pemantauan (Monitoring), Pelaporan (Reporting), dan Verifikasi secara digital menggantikan proses manual tradisional yang rawan fraud, memastikan akurasi emisi hingga ke level gram.</p>
                    </div>
                    <div class="info-card">
                        <div class="num">03</div>
                        <h3>Pembakaran Absolut (Burning)</h3>
                        <p>Ketika perusahaan menebus karbon kreditnya, sistem secara permanen akan memusnahkan token tersebut dari sirkulasi pasar (Retire) untuk mencegah penghitungan ganda (Double Counting).</p>
                    </div>
                </div>
            </div>
            ...
            <div class="network-stats fade-up" style="animation-delay: 300ms;">
                <div class="col-left" style="text-align: left;">
                    ...
                    <p>Fondasi utama dari perdagangan iklim masa depan. NusaCarbon dirancang untuk menangani likuiditas aset lingkungan terbesar di Asia tanpa hambatan throughput.</p>
                </div>
        ...
        <footer class="fat-footer">
            <div class="fat-footer-inner">
                <div>
                    ...
                    <p>Dikelola dan diawasi oleh NusaCarbon Foundation. Semua infrastruktur kode bersifat tertutup untuk skala korporat (Simulasi Akademik).</p>
                    <p style="font-size: 0.85rem; margin-top: 40px;">&copy; 2026 NusaCarbon Foundation. <br>Hak Cipta Dilindungi Undang-Undang.</p>
                </div>
